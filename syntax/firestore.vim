...
syn region firestoreFunctionCall matchgroup=firestoreDefinedFunction start=/\(exists\|get\|getAfter\)(/rs=e-1 end=/)/ nextgroup=firestoreMethod,firestoreProperty,@firestoreOp,firestoreAllow,firestoreMatchSemicolon skipwhite skipnl contains=@firestoreExpression contained keepend
hi def link firestoreDefinedFunction Identifier
syn region firestoreFunctionCall start=/\K\k*(/ end=/)/ nextgroup=firestoreMethod,firestoreProperty,@firestoreOp,firestoreAllow,firestoreMatchSemicolon skipwhite skipnl contains=@firestoreExpression contained keepend
